...
export default function Header() {
    return (
    	<header className="shadow sticky top-0">
            <nav className="bg-white px-4 lg:px-6 py-2.5 lg:w-3/4 lg:mx-auto">
                    ...
                    >
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                ...
                                to="/"
                                    className={({isActive}) =>
                                    //isActive is used so that the user knows he/she is at that page
                                        `block py-2 pr-4 pl-3 duration-200 ${isActive ? "text-orange-700" : "text-gray-700"}   lg:border-0 hover:text-orange-700 lg:p-0`
                                    }
                                >
                                    Home
                                </NavLink>
